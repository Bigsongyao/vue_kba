        ...
        <div class="index_content">
          ...
          <div class="lcr_left">
            <div class="lcr_left_con hot_big_box">
              ...
              <div class="ranking_title"><i></i>同商户店铺</div>
                      ...
                      <li v-for="(storedata,index) in store_data">
                        <div class="rank kline_rank">
                          ...
                          <div class="fl hot_box">
                            <div class="hot_data">
                              {{storedata.name}}
                              <span class="fr">{{storedata.heat}}℃</span>
                            </div>
                          </div>
                        </div>
          ...
          <div class="lcr_right">
            ...
            <div v-show="style_type == '1'" class="consult_profile_box">
              ...
              <div class="ranking_list">
                <div class="hot_shop_case pos_r">
                  <img src="../../static/img/hot_shop_top.png">
                  <div class="hot_shop_box tc">
                    <div class="teamshopimg img100">
                      <img :src="srcjgr+shop_data.logo" />
                    </div>
                    
                    <div class="hot_shop_name tc">{{shop_data.name}}</div>
                    <!--div><img src="../../static/img/star.png"></div-->

                    <div class="shop_hot_un">{{shop_data.heat}} ℃<!--span>-2 ℃</span--></div>
                    <div class="shop_data_box">
                      <div class="fl tr">团队</div><div class="fl">{{shop_data.merchant}}</div>
                      <div class="fl tr">营业额</div><div class="fl">{{shop_data.sum}}元</div>
                      <div class="fl tr">订单数</div><div class="fl">{{shop_data.order}}笔</div>
                      <div class="fl tr">粉丝数</div><div class="fl">{{shop_data.fensi}}个</div>
                    </div>
                    <div class="clear"></div>
                  </div>
                  <img src="../../static/img/hot_shop_bottom.png">
                  <div class="pos_a"></div>
                </div>
  ...
  export default {
    ...
    methods: {
      get_data() {
        ...
        this.$http.post(this.RealmUrl+'&r=kbaindex.kba.shop', Data,{
        //this.$http.post('/apis/app/index.php?i=2&c=entry&m=sunny_storev1&do=mobile&r=kbaindex.kba.shop', Data,{
          emulateJSON: true
        }).then(function(response) {
          this.shop_data = response.data.strore;
          this.store_data = response.data.merchant_store;
